...
const GetInTouch = () => {
  return (
    <section className="w-full bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-[#0066FF] rounded-lg text-center py-14 px-6">
        ...
        <h2
          className="
    font-inter font-bold tracking-[-0.03em] text-center text-white
    ...
    mb-[16px]       /* Mobile margin-bottom */
    sm:mb-[24px]    /* Tablet margin-bottom */
    lg:mb-[32px]    /* Desktop margin-bottom */
  "
        >
          Get In Touch
        </h2>
        ...
        <p
          className="
    font-inter font-normal tracking-[0em] text-center text-white/90
  ...
  "
    ...
    bg-white text-[#0066FF] font-medium 
    rounded-[8px] opacity-100 rotate-0
    px-[20px] py-[10px] w-[260px] h-[40px] text-sm   /* Mobile default */
    sm:px-[24px] sm:py-[10px] sm:w-[299px] sm:h-[50px]  /* Tablet styles */
    lg:px-[24px] lg:py-[10px] lg:w-[299px] lg:h-[62px]  /* Desktop styles */
    hover:bg-[#f1f5f9] transition-all duration-300
  "
          >
